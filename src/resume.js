            ...
            <div id="cv" class="instaFade">
                <div class="mainDetails">
                    <div id="headshot" class="quickFade">
                        <img src="https://media-exp1.licdn.com/dms/image/C5103AQEmuA6gJ0NtBQ/profile-displayphoto-shrink_100_100/0?e=1596067200&v=beta&t=5ugYB2dqZBoNfPidCFZFgGBVMuxCZupFuU0Ni7euzIk" alt="Alan Smith" />
                    </div>

                    <div id="name">
                        <h1 class="quickFade delayTwo">Amir Danish</h1>
                        <h2 class="quickFade delayThree">Fron-end Developer</h2>
                    </div>
